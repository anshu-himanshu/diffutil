...
class ProgrammingAdapter : ListAdapter<ProgrammingItem, ProgrammingAdapter.ProgrammingViewHolder >(MyDiffUtil()) {
    ...
    class MyDiffUtil : DiffUtil.ItemCallback<ProgrammingItem>(){
